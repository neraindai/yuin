    ...
    <>
      <div className="min-h-screen flex flex-col items-center bg-white">
        ...
        <div className="container mx-auto flex-col">
          ...
          <div className="flex-1 flex flex-col justify-start w-full w-full text-center mt-4">
          ...
          <div className="flex-1 flex flex-col justify-start p-10 w-full sm:w-[480px] m-auto">
              ...
              {/* Email */}
              <div className="mb-8">
                <label className="block mb-3 text-black font-montserrat font-medium">メールアドレス</label>
              ...
              <div className="mb-8">
                <label className="block mb-3 text-black font-montserrat font-medium">認証コード </label>
                <div className="flex flex-col">
                  <input type="email"                   
