...
export default function CelestialGardenHall() {
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      {/* Nav */}
      <div className="border-t border-b border-gray-200 py-3 flex justify-center text-sm text-gray-700">
        {[
          "トップ",
          "写真",
          "フェア",
          ...
          <div key={item} className="flex items-center">
            <span className="cursor-pointer hover:text-[#3a9d85]">{item}</span>
            {index < arr.length - 1 && (
