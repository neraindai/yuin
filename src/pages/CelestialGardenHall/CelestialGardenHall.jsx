    ...
    <>
      ...
      <section>
        <div className="max-w-6xl mx-auto px-4 py-6 sm:py-8">
          ...
          {/* Nav Tabs */}
          <nav className="border-t border-gray-100 py-2 lg:py-10 grid grid-cols-[repeat(3,_1fr)] lg:grid-cols-[repeat(6,_1fr)] justify-start gap-y-5 gap-x-4 items-center text-sm sm:text-base text-gray-700">
            {tabs.map((tab, index) => (
          ...
          {/* Tab Content */}
          <div className="p-2 sm:p-4 tab_footer">
