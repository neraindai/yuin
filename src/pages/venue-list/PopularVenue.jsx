...
export default function PopularVenue() {
  return (
    ...
    <div className="container">
      {/* Main Heading */}
      <div className="mt-8">
        <SectionHeader sectionTitle="人気会場" shortDescription="合計人気会場数：全38件" />
      </div>
        ...
        <div key={idx} className="mb-10">
          ...
          <div className="grid grid-cols-[1fr] lg:grid-cols-[384px,_1fr] gap-3 lg:gap-6 overflow-hidden bg-[#F9F9F9] p-3 md:p-4 lg:p-8 rounded-[10px]">
            ...
            <div className="relative h-[200px] lg:h-[100%]">
                <span className="absolute top-4 left-3 text-nm lg:text-base py-2 px-6 font-yugothic font-semibold rounded-full bg-[#E23737] text-[#fff]">おすすめ</span>
              <img
                src={event.image}
                alt={event.title}
