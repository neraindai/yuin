        ...
        <>
            {noborder?(
                ...
                <div className="flex flex-col mb-[16px] md:mb-[20px] lg:mb-[24px]">
                    <h2 className={`text-center heading font-yugothic font-bold tracking-tightest ${colorBlack? "text-black mb-[10px]" : "text-primary-text"} ${smallHeading ? "text-md md:text-xmd lg:text-lg" : "text-md md:text-lg lg:text-xl"}`}>{sectionTitle}</h2>
                </div>
            </>):(
                <>
                <div className="flex flex-col mb-[36px] md:mb-[48px] lg:mb-[64px]">
                    <h2 className={`text-center heading text-md md:text-lg lg:text-xl mt-0 font-yugothic font-bold tracking-tightest ${colorBlack? "text-black mb-[10px]" : "text-primary-text"}`}>{sectionTitle}</h2>
