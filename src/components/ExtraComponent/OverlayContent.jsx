...
const OverlayContent = ({title, description, reverseColumn}) =>{
    ...
    {!reverseColumn ? (
        ...
        <div className="flex flex-col lg:flex-row justify-center gap-6 relative mb-8 lg:mb-10 xl:mb-12">
            ...
            >
            <h3 className="text-md lg:text-lg font-bold text-primary-text font-yugothic mb-2 after:content-[''] after:flex after:w-100 after:h-[1px] after:bg-black after:mt-[8px] after:mb-[15px]">{title}</h3>
