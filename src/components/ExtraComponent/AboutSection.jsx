  ...
  return (
    <section className="container mx-auto">
      ...
      <div className="text-center mb-10">
        <h2 className="heading mt-5">ゆいのねとは</h2>
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-6 relative mb-12">
        ...
        >
          <h3 className="text-lg font-bold text-primary-text font-yugothic mb-2 after:content-[''] after:flex after:w-100 after:h-[1px] after:bg-black after:mt-[8px] after:mb-[15px]">ゆいのね」の強み</h3>
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-6 relative mb-12">
        ...
        >
          <h3 className="text-lg font-bold text-primary-text font-yugothic mb-2 after:content-[''] after:flex after:w-100 after:h-[1px] after:bg-black after:mt-[8px] after:mb-[15px]">他社との違い</h3>
          <p className="font-yugothic font-medium">
