  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      ...
      {events.map((event, idx) => (
        <div
          key={idx}
          className="flex flex-col md:flex-row gap-6 mb-10 border-b pb-8"
        >
          {/* Image */}
          ...
          <div className="md:w-2/3 flex flex-col justify-between">
            ...
            <p className="font-semibold mb-3">
              主な人数帯: <span className="text-gray-700 pl-4 font-normal">{event.guests}</span>
            </p>
            ...
            {/* Button */}
            <button
              className="w-36 py-2 rounded-full font-medium text-white text-sm text-center"
